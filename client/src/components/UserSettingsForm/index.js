              ...
              <div className="xl:px-5 shadow sm:rounded-md bg-white sm:overflow-hidden pt-5">
                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <input ref={nameRef} value={user.name} type="text" className="form-control mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Kat Midden" aria-label="name" id="userName" />
                    </div>
                    ...
                    <select value={user.location} onChange={e => setLocation(e.target.value)} className="form-select mt-1 block w-full py-2 px-3 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" id="userLocation">
                    ...
                    <select value={user.orientation} onChange={e => setOrientation(e.target.value)} className="form-select mt-1 block w-full py-2 px-3 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" id="userOrientation">
                    ...
                    <input value={user.email} ref={emailRef} type="email" className="form-control mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" id="userEmail"
                        placeholder="name@example.com" />
                    </div>
                    <div className="col-span-12 md:col-span-9 xl:col-span-9">
                        <label for="password" className="form-label block text-sm font-medium text-gray-700">Password</label>
                    <input value={user.password} ref={passwordRef} type="password" className="form-control mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" id="firstPassword"
                    />
                    </div>
                  </div>
                </div>
