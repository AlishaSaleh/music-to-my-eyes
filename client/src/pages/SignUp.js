...
>>>>>>> b1c912a946a2c47397418869aa5c0ee27ba322d6
                        ...
                        <div className="mb-4">
                            ...
                            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="firstPassword" type="password" placeholder="*******" ref={passwordRef} />
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <select onChange={e => setGender(e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="userGender">
                        ...
                        <div className="mb-4">
                            ...
                            <select onChange={e => setOrientation(e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="userOrientation">
                        ...
                        <div className="flex justify-center">
                            <button className="bg-white transition duration-300 btn-shadow ease-in-out font-bold transform hover:scale-110 mx-3 py-2 px-4 rounded border" type="submit">Sign Up</button>
                        </div>
                    </form>
                </div>
            </div>
