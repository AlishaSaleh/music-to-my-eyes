        ...
        <>
            <div>
                ...
                <div className="w-full px-6">
                    <div className="mt-8 relative rounded-lg bg-mint mx-auto flex flex-col items-center pt-12 sm:pt-24 pb-24 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64">
                        ...
                        <div className="flex justify-center items-center mb-10 sm:mb-20">
                            ...
                            <button type="button" class="btn-outline-primary text-4xl transition duration-300 ease-in-out transform hover:scale-110 border border-mint-dark hover:bg-mint-dark text-mint-dark hover:text-white font-normal py-2 px-4 rounded">Sign Up</button>
                            </div>
                            <div class="inline-block mr-2 mt-2">
                            <button type="button" class="btn-outline-primary text-4xl transition duration-300 ease-in-out transform hover:scale-110 border border-mint-dark hover:bg-mint-dark text-mint-dark hover:text-white font-normal py-2 px-4 rounded">Login</button>
                            </div>
                        </div>
                    </div>
